...
public class Room implements Closeable {
  ...
  public UserSession join(String userName, Boolean viewer, WebSocketSession session) throws IOException {
    log.info("ROOM {}: adding participant {}", this.name, userName);
    final UserSession participant = new UserSession(userName, viewer, this.name, session, this.pipeline);
  ...
  public void leave(UserSession user) throws IOException {
    ...
    this.removeParticipant(user.getName(), user.getViewer());
    user.close();
  }
  ...
  private void removeParticipant(String name, Boolean viewer) throws IOException {
  ...
  public void sendParticipantNames(UserSession user) throws IOException {
    ...
    for (final UserSession participant : this.getParticipants()) {
      if (!participant.equals(user) && !participant.getViewer()) {
